...
model](#gan_model) section provides in-depth explanation on
the use of these two neural networks.
...
layer, a loss function calculates the loss in the model and
summarises the training objective.
