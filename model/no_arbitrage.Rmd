...
discount factor (SDF) $M_t$, such that expected excess return does not
...
excess returns. A portfolio that achieve this mean-variance
...
GAN model proposed by Chen et al. (2019).
