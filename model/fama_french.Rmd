...
minus low, HML).
The four-factor model further included a momentum (UMD)
factor to account for the speed of price change.
...
outlined in @chen_deep_2019, @fama_common_1993 and
@carhart_persistence_1997 model can be considered as a
