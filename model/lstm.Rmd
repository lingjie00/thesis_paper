...
that considers the past data in future prediction. Long
Short-Term Memory (LSTM) is a sub-class of RNN that
considers more extended dynamics through a gate controlling system.
We focus our discussion here with LSTM.
...
![(#fig:lstmcell) Long short-term memory cell](./img/lstm)
