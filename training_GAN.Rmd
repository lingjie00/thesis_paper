...
As explained in the [GAN model](#GAN_model), a GAN model
simultaneously trains a discriminator and generator
simultaneously. To further increase the convergence speed,
we first train the individual network separately in a
standard neural network training procedure before training
them simultaneously in a GAN framework.
...
![(#fig:discriminator)Discriminator structure](./img/discriminator)
...
![(#fig:generator)Generator structure](./img/generator)
