...
Our model is economic motivated. The underlying assumption
is based on the no arbitrage asset pricing. We will first
explain the no arbitrage asset pricing condition before
explaining how it is linked to the generative adversarial
model through a loss function.

Stochastic discount factor (SDF) arise from consumer
maximising present and future utility by choosing asset
amount
...
### Macro-economic data with Long Term Short Term Memory (LSTM)
