...
follow standard accounting naming convention and this paper
assumes the data accuracy ensured by Finage.
This paper interpolated quarterly income statement data into
monthly data and transformed level data using log
differences.

The analysis in this paper follows @chen_deep_2019 to remove
...
Therefore, we perform two different data splitting to
...
Additionally, we retrieves a large macroeconomic dataset from
@coulombe_can_2021.
