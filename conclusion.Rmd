...
This paper empirically showed that factors relevant in
estimating SDF. Furthermore, factors are linear in
SDF, providing justifications for linear factor models.
However, there is an interaction effect between the factors
and models like GAN that considers such interaction effect
...
value-add to the empirical asset pricing.
