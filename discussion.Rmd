This paper empirically validates @chen_deep_2019's GAN
model. However, the smaller dataset used in this paper 
...
from @chen_deep_2019's paper and ours.
@chen_deep_2019 data include 50 years of historical data
...
review. Therefore, the results in this paper are still
...
few hundred USD while the GPU used in @chen_deep_2019's
costs over three thousand USD, according to the price listed
in the GPU supplier @noauthor_nvidia_2022. Moreover,
@chen_deep_2019 used eight such GPUs for the model training. Training
neural networks is also an energy-intensive task, and
@strubell_energy_2019 show that literature seldom discussed
