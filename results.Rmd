...
data splitting: *factor* and *fundamental* data.
...
Therefore, readers should consider the difference in the
dataset used when interpreting the results.
<!--
...
literature and practitioners on the required size of dataset.
